...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private EditText updateTeacherEmail, updateTeacherName, updateTeacherPost;
    ...
    private void updateData(String s) {
        ...
        databaseReference.child("teacher").child(uniqueKey).updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
            @Override
    ...
    private void deleteData() {
        ...
        pd.show();
        databaseReference.child("teacher").child(uniqueKey).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
